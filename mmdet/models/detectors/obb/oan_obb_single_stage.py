...
class oan_OBBSingleStageDetector(OBBBaseDetector):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(oan_OBBSingleStageDetector, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        Args:
            pretrained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        super(oan_OBBSingleStageDetector, self).init_weights(pretrained)
