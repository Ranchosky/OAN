...
from mmdet.models.builder import DETECTORS, build_backbone, build_head, build_neck, build_oan
...
class oan_OBBTwoStageDetector(OBBBaseDetector, RotateAugRPNTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(oan_OBBTwoStageDetector, self).__init__()
        self.backbone = build_backbone(backbone)

        if oan is not None:
            self.oan=build_oan(oan)
    ...
    def init_weights(self, pretrained=None):
        ...
        Args:
            pretrained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        super(oan_OBBTwoStageDetector, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        oan_loss = self.oan.forward_train(x,img,gt_bboxes)

        if self.with_neck:
            x = self.neck(x)

        losses = dict()
        losses.update(dict(oan_loss = oan_loss))
